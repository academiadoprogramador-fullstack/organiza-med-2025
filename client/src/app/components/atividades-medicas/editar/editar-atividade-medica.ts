...
export class EditarAtividadeMedica {
  ...
  protected atividadeMedicaForm: FormGroup = this.formBuilder.group(
    {
      inicio: [format(new Date(), 'dd/MM/yyyy HH:mm'), [Validators.required]],
      termino: [undefined],
  ...
  protected readonly atividadeMedica$ = this.route.data.pipe(
    ...
    tap((atividadeMedica) =>
      this.atividadeMedicaForm.setValue({
        inicio: format(new Date(atividadeMedica.inicio), 'dd/MM/yyyy HH:mm'),
        termino: format(new Date(atividadeMedica.termino), 'dd/MM/yyyy HH:mm'),
  ...
  public editar() {
    ...
    const atividadeMedicaModel: EditarAtividadeMedicaModel = {
      inicio: parse(this.inicio?.value, 'dd/MM/yyyy HH:mm', new Date()),
      termino: parse(this.termino?.value, 'dd/MM/yyyy HH:mm', new Date()),
